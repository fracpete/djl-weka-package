...
public class DJLUtils {
   ...
   *
   * @param context	the object trying to use DJL
   */
  public static void initClassLoader(Object context) {
    ClassLoader wekaClassLoader = WekaPackageClassLoaderManager.getWekaPackageClassLoaderManager().getLoaderForClass(context.getClass().getName());
