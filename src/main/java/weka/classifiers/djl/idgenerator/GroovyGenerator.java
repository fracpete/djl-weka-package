...
/**
 * Uses the specified Groovy script to generate the ID.
 *
...
public class GroovyGenerator
  ...
  protected transient IDGenerator m_GroovyObject = null;
  ...
  public String globalInfo() {
    return "Loads the specified Groovy script (which must implement " + IDGenerator.class.getName()
	     + ") and uses it to generate the ID with.";
  }
  ...
  protected void initGroovyObject() {
	...
	m_GroovyObject = (IDGenerator) GroovyMod.newInstance(m_GroovyModule, IDGenerator.class, getClass().getClassLoader());
      }
