...
/**
 * Uses the specified Groovy script to generate the output dir.
 *
...
public class GroovyGenerator
  ...
  protected transient OutputDirGenerator m_GroovyObject = null;
  ...
  public String globalInfo() {
    return "Loads the specified Groovy script (which must implement " + OutputDirGenerator.class.getName()
	     + ") and uses it to generate the output dir with.";
  }
  ...
  protected void initGroovyObject() {
	...
	m_GroovyObject = (OutputDirGenerator) GroovyMod.newInstance(m_GroovyModule, OutputDirGenerator.class, getClass().getClassLoader());
      }
