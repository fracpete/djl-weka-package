...
/*
 * AbstractTrainingConfigGenerator.java
...
/**
 * Ancestor for training config generators.
 *
 * @author fracpete (fracpete at waikato dot ac dot nz)
 */
public abstract class AbstractTrainingConfigGenerator
  implements TrainingConfigGenerator, OptionHandler, Serializable {
  ...
  /**
   * Checks the setup before generating the training config.
   *
   ...
   */
  protected abstract TrainingConfig doGenerate();
