...
public class GroovyGenerator
  extends AbstractTrainingConfigGenerator {
  ...
  protected transient TrainingConfigGenerator m_GroovyObject = null;
  ...
  public String globalInfo() {
    return "Loads the specified Groovy script (which must implement " + TrainingConfigGenerator.class.getName()
	     + ") and uses it to generate the training config.";
  }
  ...
  protected void initGroovyObject() {
	...
	m_GroovyObject = (TrainingConfigGenerator) GroovyMod.newInstance(m_GroovyModule, TrainingConfigGenerator.class, getClass().getClassLoader());
      }
   ...
   */
  @Override
  protected TrainingConfig doGenerate() {
    initGroovyObject();
    return m_GroovyObject.generate();
  }
}
