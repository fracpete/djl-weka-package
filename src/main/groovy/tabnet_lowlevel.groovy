...
import weka.classifiers.djl.networkgenerator.AbstractNetworkGenerator


public class TabNetGeneratorLowLevel extends AbstractNetworkGenerator {
 ...
 */
    public static class TabNetLowLevel extends AbstractBlock {
        ...
        /**
         * Creates a {@link TabNetLowLevel} instance with given builder.
         *
         * @param builder the builder to create TabNet
         */
        private TabNetLowLevel(Builder builder) {
            super(VERSION)
            batchNorm =
                    addChildBlock(
                            "batchNorm",
        ...
        protected NDList forwardInternal(
            ...
            input = input.reshape((long) input.size(0), (long) (input.size() / input.size(0))) // batch flatten
            NDArray x =
        ...
        public static class Builder {
             ...
             */
            public Block build() {
                return new TabNetLowLevel(this)
            }
        }
    }
